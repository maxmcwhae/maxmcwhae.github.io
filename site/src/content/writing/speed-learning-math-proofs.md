---
title: "Speed-learning mathematics proofs with a claude code prompts"
date: 2026-08-04
description: "A Claude Code prompt for generating formal proofs, tactics, and Anki flashcards from first-year mathematics units."
---
...
1. You have broken down the tasks and started.
2. You have read EVERY resource in this folder (just restrict reading to weeks1-3 for each unit to save yourself effort) - including the bookofproof.pdf (the orchestrating substrate) - the unit readers are supporting content.
3. You have brainstormed proof tactics and proof strategies to include to maximally enhance learning.
4. You have generated 21 proofs (7 for each MATH unit) - under each proof explain why it is beautiful <3.
5. You have formally written each 21 proofs divided into three .md +mathJAX & lyx document (labelled MATH1011.mg, MATH1012.md, MATH1014.md).
6. You have create TWO Anki spaced-repetition decks for review.
